...
const Signup = () => {
  const [data, setData] = useState({
    ...
    about: "",
    profileURL:
      "https://emp.lbl.gov/sites/default/files/styles/large/public/staffimage/noprofileimage-dark-min_0.png?itok=xmzGhDhv",
  });
        ...
        <div className="py-5">
          ...
          <form action="#!" className="mt-5" onSubmit={doSignup}>
            ...
            <div className="mt-3 text-center">
              ...
              <button onClick={resetForm} type="button" className="px-3 py-2 bg-orange-600 rounded ms-3 hover:bg-orange-400">
                Reset
              </button>
            </div>
            {/* {JSON.stringify(data)} */}
